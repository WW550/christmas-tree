This is a Python script that displays a Christmas tree in text form with changing colored lights. The script uses the colorama library for colored text. 
